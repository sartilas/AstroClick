...
export const dictionary: Record<Language, any> = {
    en: {
        ...
        rocketTooltip: "Press SPACE to launch a satellite!",
        ...
        objects: {
            ...
            phobos: { name: "Phobos", desc: "The larger and inner moon of Mars. It is a lumpy, heavily cratered rock.", funFact: "Phobos gets closer to Mars every year! It will eventually crash or break apart." },
            deimos: { name: "Deimos", desc: "The smaller and outer moon of Mars. It looks more like a smooth asteroid.", funFact: "Deimos is much smaller drifting further away from Mars." },
            io: { name: "Io", desc: "Jupiter's volcanic moon. Its yellow color comes from sulfur from its massive eruptions.", funFact: "Io is the most volcanically active body in the solar system!" },
            europa: { name: "Europa", desc: "An icy moon with a smooth surface. Scientists believe a vast ocean lies beneath the ice.", funFact: "Europa has a subsurface ocean of liquid water with more water than Earth!" },
            ganymede: { name: "Ganymede", desc: "The giant of moons. It is the only moon known to have its own magnetic field.", funFact: "Ganymede is the largest moon in the solar system - bigger than Mercury!" },
            callisto: { name: "Callisto", desc: "An old, cratered moon. It may also have a subsurface salty ocean.", funFact: "Callisto is the most heavily cratered object in the solar system." },
            titan: { name: "Titan", desc: "Saturn's largest moon. It has a thick nitrogen atmosphere and is like a frozen Earth.", funFact: "Titan has a thick atmosphere and liquid lakes of methane and ethane!" },
            enceladus: { name: "Enceladus", desc: "A shiny, icy moon with a subsurface ocean that might be habitable.", funFact: "Enceladus shoots geysers of salty water into space!" },
            titania: { name: "Titania", desc: "The largest moon of Uranus. A dirty ice ball mixed with rock.", funFact: "Titania has a giant canyon that dwarfs the Grand Canyon on Earth." },
            triton: { name: "Triton", desc: "The only large moon in the solar system that orbits in the opposite direction.", funFact: "Triton likely came from the Kuiper Belt and was captured by Neptune." },
            charon: { name: "Charon", desc: "Pluto's largest moon. It forms a binary system with Pluto.", funFact: "Charon is so big compared to Pluto that they orbit each other!" },
            // Lagrange Points
            l1: { name: "L1 Point", desc: "Located directly between the Sun and Earth. It provides an uninterrupted view of the Sun.", funFact: "The SOHO satellite is parked here to monitor solar storms 24/7!" },
            l2: { name: "L2 Point", desc: "Located behind Earth (from the Sun). perfect for space telescopes as Earth blocks the Sun's brightness.", funFact: "The James Webb Space Telescope orbits here to keep its instruments super cold!" },
            l3: { name: "L3 Point", desc: "Hidden behind the Sun, opposite to Earth. It's unstable and rarely used.", funFact: "Sci-fi stories often hide a 'Counter-Earth' here, but we'd see its gravity affecting other planets!" },
            l4: { name: "L4 Point", desc: "60° ahead of Earth in its orbit. It's a stable gravitational 'parking spot'.", funFact: "Asteroids naturally collect here! These are called 'Trojan asteroids'." },
            l5: { name: "L5 Point", desc: "60° behind Earth in its orbit. Like L4, it's a stable region.", funFact: "Some scientists propose this as a perfect location for future giant space colonies!" },
    ...
    fr: {
        ...
        rocketTooltip: "Appuyez sur ESPACE pour lancer un satellite !",
        ...
        objects: {
            ...
            phobos: { name: "Phobos", desc: "La plus grande lune de Mars. C'est un rocher bosselé et très cratérisé.", funFact: "Phobos se rapproche de Mars chaque année ! Elle finira par s'écraser ou se disloquer." },
            deimos: { name: "Deimos", desc: "La plus petite lune de Mars. Elle ressemble plus à un astéroïde lisse.", funFact: "Deimos est beaucoup plus petite que Phobos et s'éloigne lentement de Mars." },
            io: { name: "Io", desc: "La lune volcanique de Jupiter. Sa couleur jaune vient du soufre de ses éruptions massives.", funFact: "Io est le corps le plus volcaniquement actif du système solaire !" },
            europa: { name: "Europe", desc: "Une lune glacée à la surface lisse. Les scientifiques pensent qu'un vaste océan se cache sous la glace.", funFact: "Europe possède un océan souterrain contenant plus d'eau que tous les océans terrestres !" },
            ganymede: { name: "Ganymède", desc: "La géante des lunes. C'est la seule lune connue pour avoir son propre champ magnétique.", funFact: "Ganymède est la plus grande lune du système solaire - plus grande que Mercure !" },
            callisto: { name: "Callisto", desc: "Une vieille lune cratérisée. Elle pourrait aussi avoir un océan salé souterrain.", funFact: "Callisto est l'objet le plus cratérisé du système solaire." },
            titan: { name: "Titan", desc: "La plus grande lune de Saturne. Elle a une atmosphère épaisse et ressemble à une Terre gelée.", funFact: "Titan possède une atmosphère épaisse et des lacs liquides de méthane et d'éthane !" },
            enceladus: { name: "Encelade", desc: "Une lune glacée et brillante avec un océan souterrain potentiellement habitable.", funFact: "Encelade propulse des geysers d'eau salée dans l'espace !" },
            titania: { name: "Titania", desc: "La plus grande lune d'Uranus. Une boule de glace sale mélangée à de la roche.", funFact: "Titania possède un canyon géant qui éclipse le Grand Canyon sur Terre." },
            triton: { name: "Triton", desc: "La seule grande lune du système solaire à orbiter dans la direction opposée.", funFact: "Triton vient probablement de la ceinture de Kuiper et a été capturée par Neptune." },
            charon: { name: "Charon", desc: "La plus grande lune de Pluton. Elle forme un système binaire avec Pluton.", funFact: "Charon est si grande par rapport à Pluton qu'elles orbitent l'une autour de l'autre !" },
            // Points de Lagrange
            l1: { name: "Point L1", desc: "Situé directement entre le Soleil et la Terre. Idéal pour observer le Soleil en permanence.", funFact: "Le satellite SOHO est stationné ici pour surveiller les tempêtes solaires 24h/24 !" },
            l2: { name: "Point L2", desc: "Situé derrière la Terre (par rapport au Soleil). Parfait pour les télescopes car la Terre bloque la lumière du Soleil.", funFact: "Le télescope James Webb orbite ici pour garder ses instruments au froid absolu !" },
            l3: { name: "Point L3", desc: "Caché derrière le Soleil, à l'opposé de la Terre. C'est un point instable.", funFact: "La science-fiction y cache souvent une 'Contre-Terre', mais nous verrions ses effets gravitationnels !" },
            l4: { name: "Point L4", desc: "Situé à 60° devant la Terre sur son orbite. C'est un 'parking' gravitationnel stable.", funFact: "Les astéroïdes s'y accumulent naturellement ! On les appelle les 'Troyens'." },
            l5: { name: "Point L5", desc: "Situé à 60° derrière la Terre. Comme L4, c'est une zone très stable.", funFact: "Certains scientifiques voient ce point comme l'endroit idéal pour de futures colonies spatiales géantes !" },
            // Système Kerbol (KSP)
            kerbol: {
                name: "Kerbol",
    ...
    zh: {
        ...
        objects: {
            ...
            phobos: { name: "火卫一", desc: "火星两颗卫星中较大、较内侧的一颗。它是一块凹凸不平、布满陨石坑的岩石。", funFact: "火卫一每年都离火星更近！最终它会坠毁或解体。" },
            deimos: { name: "火卫二", desc: "火星较小、较外侧的卫星。它看起来更像是一个光滑的小行星。", funFact: "火卫二比火卫一小得多，并且正在缓慢远离火星。" },
            io: { name: "木卫一", desc: "木星的火山卫星。它的黄色来自大规模火山喷发出的硫磺。", funFact: "木卫一是太阳系中火山活动最剧烈的天体！" },
            europa: { name: "木卫二", desc: "一颗表面通过光滑的冰卫星。科学家认为冰层下隐藏着巨大的海洋。", funFact: "木卫二拥有一个地下海洋，水量比地球上所有海洋加起来还多！" },
            ganymede: { name: "木卫三", desc: "卫星之王。它是唯一已知拥有自己磁场的卫星。", funFact: "木卫三是太阳系中最大的卫星——比水星还大！" },
            callisto: { name: "木卫四", desc: "一颗古老的、布满陨石坑的卫星。它可能也有一个地下咸水海洋。", funFact: "木卫四是太阳系中陨石坑最密集的物体。" },
            titan: { name: "土卫六", desc: "土星最大的卫星。它有浓厚的大气层，就像一个冰冻的地球。", funFact: "土卫六拥有浓厚的大气层和液态甲烷、乙烷湖泊！" },
            enceladus: { name: "土卫二", desc: "一颗闪亮、冰冷的卫星，拥有可能适宜居住的地下海洋。", funFact: "土卫二向太空喷射咸水喷泉！" },
            titania: { name: "天卫三", desc: "天王星最大的卫星。一个混合了岩石的脏冰球。", funFact: "天卫三有一个巨大的峡谷，使地球上的大峡谷相形见绌。" },
            triton: { name: "海卫一", desc: "太阳系中唯一逆向公转的大型卫星。", funFact: "海卫一可能来自柯伊伯带，被海王星捕获。" },
            charon: { name: "冥卫一", desc: "冥王星最大的卫星。它与冥王星形成双星系统。", funFact: "冥卫一相对于冥王星非常大，以至于它们互绕旋转！" },
            // Kerbol系统
    ...
    es: {
        ...
        rocketTooltip: "¡Presiona ESPACIO para lanzar un satélite!",
        ...
        objects: {
            ...
            phobos: { name: "Fobos", desc: "La luna más grande e interior de Marte. Es una roca grumosa y muy craterizada.", funFact: "¡Fobos se acerca a Marte cada año! Eventualmente chocará o se romperá." },
            deimos: { name: "Deimos", desc: "La luna más pequeña y exterior de Marte. Parece más un asteroide suave.", funFact: "Deimos es mucho más pequeño y se aleja lentamente de Marte." },
            io: { name: "Ío", desc: "La luna volcánica de Júpiter. Su color amarillo proviene del azufre de sus erupciones masivas.", funFact: "¡Ío es el cuerpo volcánicamente más activo del sistema solar!" },
            europa: { name: "Europa", desc: "Una luna helada con superficie lisa. Los científicos creen que un vasto océano yace bajo el hielo.", funFact: "¡Europa tiene un océano subterráneo con más agua que la Tierra!" },
            ganymede: { name: "Ganímedes", desc: "El gigante de las lunas. Es la única luna conocida con su propio campo magnético.", funFact: "¡Ganímedes es la luna más grande del sistema solar, más grande que Mercurio!" },
            callisto: { name: "Calisto", desc: "Una luna antigua y craterizada. También podría tener un océano subterráneo salado.", funFact: "Calisto es el objeto más craterizado del sistema solar." },
            titan: { name: "Titán", desc: "La luna más grande de Saturno. Tiene una atmósfera espesa y es como una Tierra congelada.", funFact: "¡Titán tiene una atmósfera espesa y lagos líquidos de metano y etano!" },
            enceladus: { name: "Encélado", desc: "Una luna brillante y helada con un océano subterráneo que podría ser habitable.", funFact: "¡Encélado dispara géiseres de agua salada al espacio!" },
            titania: { name: "Titania", desc: "La luna más grande de Urano. Una bola de hielo sucio mezclada con roca.", funFact: "Titania tiene un cañón gigante que empequeñece al Gran Cañón de la Tierra." },
            triton: { name: "Tritón", desc: "La única luna grande del sistema solar que orbita en dirección opuesta.", funFact: "Probablemente Tritón vino del Cinturón de Kuiper y fue capturado por Neptuno." },
            charon: { name: "Caronte", desc: "La luna más grande de Plutón. Forma un sistema binario con Plutón.", funFact: "¡Caronte es tan grande en comparación con Plutón que orbitan entre sí!" },
            // Sistema Kerbol
    ...
    hi: {
        ...
        rocketTooltip: "उपग्रह लॉन्च करने के लिए स्पेस दबाएं!",
        ...
        objects: {
            ...
            phobos: { name: "फोबोस", desc: "मंगल का बड़ा और भीतरी चंद्रमा। यह एक ऊबड़-खाबड़, गड्ढों वाली चट्टान है।", funFact: "फोबोस हर साल मंगल के करीब आता है! यह अंततः दुर्घटनाग्रस्त हो जाएगा या टूट जाएगा।" },
            deimos: { name: "डेमोस", desc: "मंगल का छोटा और बाहरी चंद्रमा। यह एक चिकने क्षुद्रग्रह जैसा दिखता है।", funFact: "डेमोस बहुत छोटा है और धीरे-धीरे मंगल से दूर जा रहा है।" },
            io: { name: "आयो", desc: "बृहस्पति का ज्वालामुखीय चंद्रमा। इसका पीला रंग इसके बड़े पैमाने पर विस्फोटों से सल्फर से आता है।", funFact: "आयो सौर मंडल में सबसे अधिक ज्वालामुखीय रूप से सक्रिय पिंड है!" },
            europa: { name: "यूरोपा", desc: "एक बर्फीला चंद्रमा जिसकी सतह चिकनी है। वैज्ञानिकों का मानना है कि बर्फ के नीचे एक विशाल महासागर है।", funFact: "यूरोपा के पास एक उपसतह महासागर है जिसमें पृथ्वी से अधिक पानी है!" },
            ganymede: { name: "गेनीमेड", desc: "चंद्रमाओं का विशाल। यह एकमात्र चंद्रमा है जिसका अपना चुंबकीय क्षेत्र है।", funFact: "गेनीमेड सौर मंडल का सबसे बड़ा चंद्रमा है - बुध से भी बड़ा!" },
            callisto: { name: "कैलिस्टो", desc: "एक पुराना, गड्ढों वाला चंद्रमा। इसमें एक उपसतह नमकीन महासागर भी हो सकता है।", funFact: "कैलिस्टो सौर मंडल में सबसे अधिक गड्ढों वाला पिंड है।" },
            titan: { name: "टाइटन", desc: "शनि का सबसे बड़ा चंद्रमा। इसका नाइट्रोजन वायुमंडल घना है और यह जमे हुए पृथ्वी जैसा है।", funFact: "टाइटन के पास घना वायुमंडल और मीथेन और ईथेन की तरल झीलें हैं!" },
            enceladus: { name: "एन्सेलेडस", desc: "एक चमकदार, बर्फीला चंद्रमा जिसमें एक उपसतह महासागर है जो रहने योग्य हो सकता है।", funFact: "एन्सेलेडस अंतरिक्ष में नमकीन पानी के गीजर छोड़ता है!" },
            titania: { name: "टाइटेनिया", desc: "अरुण का सबसे बड़ा चंद्रमा। चट्टान के साथ मिश्रित एक गंदी बर्फ की गेंद।", funFact: "टाइटेनिया में एक विशाल घाटी है जो पृथ्वी पर ग्रांड कैन्यन को बौना बना देती है।" },
            triton: { name: "ट्राइटन", desc: "सौर मंडल का एकमात्र बड़ा चंद्रमा जो विपरीत दिशा में परिक्रमा करता है।", funFact: "ट्राइटन संभवतः कुइपर बेल्ट से आया था और वरुण द्वारा कब्जा कर लिया गया था।" },
            charon: { name: "कैरन", desc: "प्लूटो का सबसे बड़ा चंद्रमा। यह प्लूटो के साथ एक बाइनरी सिस्टम बनाता है।", funFact: "कैरन प्लूटो की तुलना में इतना बड़ा है कि वे एक-दूसरे की परिक्रमा करते हैं!" },
            // Kerbol सिस्टम
